...
export default function Register() {
  ...
  const signUpWIthGoogle = (credentialResponse) => {
    ...
    const body = { name: dataUser.name, email: dataUser.email, password: dataUser.given_name + dataUser.sub, image: dataUser.picture, }     
    dispatch(signUpAction(body)); 
    Toast.fire({ icon: 'success', text: 'Registered successfully, logged in', title: 'Success' }); 
    navigate('/')
  }
      ...
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
        ...
        <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
          ...
          <div className="flex mt-4 gap-x-2">
            ...
            <GoogleButton onSuccess={signUpWIthGoogle}/>
